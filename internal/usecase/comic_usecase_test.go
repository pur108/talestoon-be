...
// 			if !tt.wantErr {
// 				assert.NotNil(t, got)
// 				// assert.Equal(t, tt.args.input.Title.En, got.Translations[0].Title) // Hard to check order, skip for now or improve check
...
// 	comic := &entity.Comic{
// 		ID: comicID,
// 		// Title: entity.MultilingualText{En: "Test Comic"}, // Field removed
...
// 					// Seasons:        []entity.Season{}, // Removed
// 					Chapters: []entity.Chapter{}, // Added flat Chapters
// 				}
// 				f.comicRepo.On("GetComicByID", comicID).Return(comic, nil)
